...
namespace DrawGeometryShape { 
    public class Parse:Form1
    {
        ...
        Dictionary<ArrayList, Dictionary<String, String>> methods;  
        //stores the index/ID,name of method and its variable dictionary
        int[,] methodRecorder;        
        ...
        /// 
        /// </summary>
        /// <param name="expression">Object of the datatable that returns param in the expression</param>
        /// <returns></returns>
        ...
        /// 
        /// </summary>
        /// <param name="expression">Stores the value in the expression param</param>
        /// <param name="varDict">Stores in the array as a string</param>
        /// <returns></returns>
        ...
        /// 
        /// </summary>
        /// <param name="rtb">rtb acts as the richboxtext</param>
        /// <param name="displayCanvas">Object of the canvas that prints </param>
        /// <param name="errorList">that checks the error in the richbox text</param>
        ...
        /// 
        /// </summary>
        /// <param name="parameters">stores in the parameters</param>
        public void preParser(params object[] parameters)
        {
            ...
            if (command.Equals("square") || command.Equals("circle") || command.Equals("rectangle") || command.Equals("triangle")
        ...
        /// <summary>
        /// 
        /// <param name="line">checks in the string of the text in the line</param>
        /// <param name="lineNo">scans as the </param>
        ///   /// </summary>
        public void runCommand(String line, int lineNo)
        {
            ...
            switch (command)
            {
                ...
                case "method":
                    methodRunning = true;
                    line = line.Substring(6, line.Length - 6).Trim();  
                    //removes the method token
                ...
                case "endmethod":
                    ...
                    break;
                default:  
                    //check for variable or method name
                        ...
                        //check for method call
                    {
                        ...
                        if (match)       
                            //the name of the method matched
                        {
                        ...
                        {
                            this.errorList.Append("\r\n Oppps Sorry :( Invalid Line Error at  " + lineNo);
                        }
                    }
                    else
                    {
        ...
        public bool checkValidCommand(String line)
        {
            ...
            if (words.Length > 0 && !(words[0].Equals("square") || words[0].Equals("circle") || words[0].Equals("rectangle") || words[0].Equals("triangle")
        ...
        public void parseLine(StringBuilder errorList, Canvas displayCanvas, String line,  int numLine)
        {
            ...
            else if(words.Length == 2)
            {
                ...
                || ((words[0].Equals("rectangle") || words[0].Equals("drawto") || words[0].Equals("moveto")) && intParam.Length != 4)
               ...
               if (words[0].Equals("moveto"))
                ...
                if (words[0].Equals("square") || words[0].Equals("circle") ||  words[0].Equals("rectangle") || words[0].Equals("triangle"))
                {
